...
import { createProfile, getCurrentProfile } from '../../actions/profile'; // Ensure createProfile is imported
...
const EditProfile = ({ profile: { profile,loading }, createProfile, getCurrentProfile }) => {
    ...
    }, [profile, loading]); // This useEffect will update form data when profile or loading state changes    
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        createProfile(formData, navigate, true); // Use navigate instead of history
    };
